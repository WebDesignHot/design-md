...
[**Browse all 490 →**](https://www.webdesignhot.com/design.md/) · [**Install the CLI**](https://www.npmjs.com/package/@webdesignhot/design-md) · [**MCP server**](https://www.npmjs.com/package/@webdesignhot/design-md-mcp)
...
1. **Extracted 490 real brands** from production marketing sites (not invented "vibes")
...
npx -y @webdesignhot/design-md list                   # browse all 490
```
